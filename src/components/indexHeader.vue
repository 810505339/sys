 ...
 * @LastEditTime: 2022-11-20 21:49:40
 * @LastEditors: yxx
 * @Description:首页头
...
const style = userStore.themeColor[userStore.commonStyle as keyof typeof userStore.themeColor]
</script>

<template>
  <div
    class="h-23  flex px-9 bg-contain  bg-center"
  ...
  >
    ...
    <div class="w-100 text-right mt-5">
      ...
      <n-button type="info" :ghost="false">
        型号
      </n-button>
        ...
        >
          <g>
			...
			C341.1,404.2,299.7,421.3,255.7,421.3z"
              ...
              <rect
                x="447.4" y="255.4"
                transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 583.767 753.7971)" width="1.2"
                height="1.2"
              />
            </g>
          </g>
