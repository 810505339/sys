 ...
 * @LastEditTime: 2022-12-03 17:49:15
 * @LastEditors: yxx
 * @Description:全国态势
...
const title1 = ref('');
const moreClick = (type: string, title: string) => {
    if (!title) {
        show = true;
    }
    dataType = type;
...
<template>
    <div
        class="relative flex w-100% mx-auto mt-4"
        justify-between
        items-start
        px5
    >
        ...
        <div w="20%">
            <NavBox
                ...
                :modalData="modalData"
                :modalCol="modalCol"
                @moreClick="moreClick('state', '产品状态')"
            >
                <div flex items-center justify-center mt5>
                    <n-data-table
                        :data="stateInfo"
          ...
          <BarChart />
            ...
            <NavBox
                ...
                :modalCol="modalCol"
                mt5
                @moreClick="moreClick('quality', '问题记录')"
            >
                <div flex items-center justify-center mt5>
                    <n-data-table
                        :data="qualityInfo"
